...
4. Перейдите на [доску анализа Chess.com](https://www.chess.com/analysis).
...
ДРУГИХ РЕСУРСОВ НЕТ: данный проект уникакльный в своём роде, НИКТО не догадывался что можно делать анимации на шахматной доске Chess.com
...
- Сохранение настроек пользователя (тема интерфейса, выбранный язык)
- Адаптивный дизайн с темной и светлой темами
